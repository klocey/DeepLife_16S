...
mydir2 = os.path.expanduser("~/GitHub/MicrobialScaling2/")

OrC = 'closed'

def GetSADsFromBiom_labeled(path):

    minS = 2

    IN = path + '/SSADdata.txt'
    ...
    OUT = open(path + '/Louca_SbyS.txt','w+')
...
GetSADsFromBiom_labeled(mydir2 +'data/Louca')
